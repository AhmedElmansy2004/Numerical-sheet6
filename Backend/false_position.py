...
def do_false_position(func, from_val, to_val, precision, epsilon=0.00001, maxIterations = 50):
    ...
    solution_steps = [{"x_l": x_l, "x_u": x_u, "x_r": x_r, "y_l": y_l, "y_u": y_u, "y_r": y_r, "eps": -1}]
    ...
    for i in range(maxIterations):    
        ...
        if(y_l * y_r < 0):
            ...
            solution_steps.append({"x_l": x_l, "x_u": x_u, "x_r": x_r, "y_l": y_l, "y_u": y_u, "y_r": y_r, "eps": relative_error})
            break
