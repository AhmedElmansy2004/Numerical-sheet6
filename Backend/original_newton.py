from essential_functions import getValue, getDerivative, getEPS
...
def do_original_newton(func, intial, precision, epsilon=0.00001, maxIterations = 50):
    ...
    # diverge
    if(getDerivative(func, x_old) == 0): return False, x_old, 0, -1, precision, None
    ...
    for i in range(maxIterations):
        ...
        # diverge
        if(getDerivative(func, x_old) == 0): return False, x_new, i+1, -1, precision, solution_steps
